...
int main(void)
{
  ...
  retval = retval | test_eval("01 01 000010 0000110 000010", "#<proc>");// 000010
  retval = retval | test_eval("01 01 0000110 0000110 000010", "#<proc>");// 0000110
  ...
  retval = retval | test_eval("01 01 000010 001110 00110", "#<proc>");// 00110
  retval = retval | test_eval("01 01 0000110 001110 00110", "#<proc>");// 001110
  retval = retval | test_eval("01 00110 0010", "10");
  retval = retval | test_eval("0100100010", "#<proc>");// 0010
#else
